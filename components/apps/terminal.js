        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full">
                    <div className="flex">
                        <div className=" text-blue-500 ">Chetan@kali</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-chetan, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-chetan":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-chetan");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-chetan, todoist, trash, settings, sendmsg ]";
                }
                break;
